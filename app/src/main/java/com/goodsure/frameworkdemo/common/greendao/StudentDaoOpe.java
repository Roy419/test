...
public class StudentDaoOpe {
  /*  *//**
    ...
    *//**
     ...
     * @return
     *//*
    public static List<Student> queryAll(Context context, int pageSize, int pageNum) {
        QueryBuilder<Student> builder = DbManager.getDaoSession(context, DbManager.DB_NAME,"123456").getStudentDao().queryBuilder();
        List<Student> list = builder
                .offset(pageSize - 1)//从0开始的
                .limit(pageNum)
                //.orderDesc(Student.Properties.Id)
                .build()
                .list();
        return list;
    }*/
